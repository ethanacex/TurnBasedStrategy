...
namespace StrategyGame.Media
{
    ...
    {
        public static Texture2D Transparent { get; } = ContentService.Instance.Textures["Empty"];
        public static Texture2D Black { get; } = ContentService.Instance.Textures["Black"];
